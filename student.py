...
#
#         #first image
#         img=Image.open(r"C:\Users\PC_MINH THIEN\PycharmProjects\PythonProjectAI2\college_images\logocaothang.png")
...
#
#         #student id  ==> O.N
#         studenId_label=Label(class_Student_frame,text="STT:", font=("times new roman",13,"bold"),bg="white")
#         studenId_label.grid(row=0,column=0,padx=10,pady=5,sticky=W)
#
...
#
#         # Roll No ==> studentID
#         roll_no_label = Label(class_Student_frame, text="Student_ID:", font=("times new roman", 13, "bold"), bg="white")
...
#
#         self.student_table=ttk.Treeview(table_frame,columns=("dep","course","year","sem","on","name","div","studentid","gender","dob","email","phone","address","teacher","photo"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
#
...
#         self.student_table.heading("on", text="O.N")
...
#
#                 #=========clear image===================
#                 path1 = (r'C:\Users\PC_MINH THIEN\PycharmProjects\PythonProjectAI2\data')
#                 shutil.rmtree(path1)
