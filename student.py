...
class Student:
    def __init__(self,root):
        ...
        #student id  ==> O.N
        studenId_label=Label(class_Student_frame,text="O.N:", font=("times new roman",13,"bold"),bg="white")
        ...
        # Roll No ==> studentID
        roll_no_label = Label(class_Student_frame, text="Student_ID/Roll:", font=("times new roman", 13, "bold"), bg="white")
