...
class Student:
    def __init__(self,root):
        ...
        #second image
        img1=Image.open(r"C:\Users\PC_MINH THIEN\PycharmProjects\PythonProjectAI2\college_images\logocaothang.PNG")
        ...
        #third image
        img2=Image.open(r"C:\Users\PC_MINH THIEN\PycharmProjects\PythonProjectAI2\college_images\image1.png")
        ...
        #Course
        course_label=Label(current_course_frame,text="Khóa học:", font=("times new roman",13,"bold"),bg="white")
        ...
        #STT
        stt_label=Label(class_Student_frame,text="STT:", font=("times new roman",13,"bold"),bg="white")
        stt_label.grid(row=0,column=0,padx=10,pady=5,sticky=W)

        stt_entry=ttk.Entry(class_Student_frame,textvariable=self.var_stt,width=20,font=("times new roman",13,"bold"))
        stt_entry.grid(row=0,column=1,padx=10,pady=5,sticky=W)
        ...
        # class didvision
        class_div_label = Label(class_Student_frame, text="Lớp đào tạo:", font=("times new roman", 13, "bold"), bg="white")
        ...
        #studentID
        std_id_label = Label(class_Student_frame, text="MSSV:", font=("times new roman", 13, "bold"), bg="white")
        std_id_label.grid(row=1, column=2, padx=10, pady=5, sticky=W)

        std_id_entry = ttk.Entry(class_Student_frame,textvariable=self.var_std_id, width=20, font=("times new roman", 13, "bold"))
        std_id_entry.grid(row=1, column=3, padx=10, pady=5, sticky=W)
        ...
        # phone No
        phone_label = Label(class_Student_frame, text="Số điện thoại:", font=("times new roman", 13, "bold"), bg="white")
        ...
        # Teacher name
        teacher_label = Label(class_Student_frame, text="Tên Giảng Viên:", font=("times new roman", 13, "bold"), bg="white")
        ...
        update_photo_btn = Button(btn_frame1,command=self.clear_data, text="Erase All Data", width=35, font=("times new roman", 13, "bold"), bg="red", fg="white")
