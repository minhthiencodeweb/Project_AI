...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        #student button
        img4=Image.open(r"college_images\student-detail1.jpg")
        ...
        #Detect face button
        img5=Image.open(r"college_images\face-detec.png")
        ...
        img6=Image.open(r"college_images\attendance1.jpg")
        ...
        #Help face button
        img7=Image.open(r"college_images\help-desk12.png")
        ...
        #Train face button
        img8=Image.open(r"college_images\robottrain.jpg")
        ...
        #Admin face button
        img10=Image.open(r"college_images\Senior-Dev1.jpg")
        img10=img10.resize((220,220), Image.ANTIALIAS)
        self.photoimg10=ImageTk.PhotoImage(img10)

        b1=Button(bg_img, image=self.photoimg10,cursor="hand2",command=self.add_admin_data)
        b1.place(x=800, y=380, width=220, height=220)

        b1_1=Button(bg_img, text="System Admin",cursor="hand2",command=self.add_admin_data,font=("times new roman",15,"bold"),bg="blue",fg="white")
        b1_1.place(x=800, y=580, width=220, height=40)

        #Exit face button
        img11=Image.open(r"college_images\exitout.jpg")
    ...
    def add_admin_data(self):
        self.new_window=Toplevel(self.root)
        self.app=adminstator(self.new_window)
