...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        title_lbl=Label(bg_img,text="FACE REOCOGNITION ATTENDANCE SYSTEM SOFTWARE",font=("times new roman",35,"bold"),bg="white",fg="red")
        ...
        #Photos face button
        img9=Image.open(r"college_images\opencv_face.jpg")
        ...
        img10=Image.open(r"college_images\Team-Development.jpg")
